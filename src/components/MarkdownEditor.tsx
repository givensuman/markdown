...
const MarkdownEditor = forwardRef(function MarkdownEditor(
  ...
  const handleEditorDidMount: OnMount = (editor) => {
    ...
    monaco.editor.defineTheme('github-dark', {
      base: themes.dark.base as 'vs-dark',
      inherit: themes.dark.inherit,
      rules: themes.dark.rules.map(rule => ({
        ...rule
      })),
    ...
    monaco.editor.defineTheme('github-light', {
      base: themes.light.base as 'vs',
      inherit: themes.light.inherit,
      rules: themes.light.rules.map(rule => ({
        ...rule
      })),
